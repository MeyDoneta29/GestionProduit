...
<body class="bg-gray-100 p-8">
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <a href="{{ route('products.create') }}" class="mb-4 inline-block bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
            Ajouter un Produit
        </a>
                    ...
                    @foreach($produits as $produit)
                        <tr>
                            ...
                            <td class="border border-gray-300 px-4 py-2">
                                <a href="{{ route('products.edit', $produit->id) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded mr-2">
                                    Modifier
                                </a>
                                <form action="{{ route('products.delete', $produit->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce produit ?')" class="inline">
                                    @csrf
                                    @method('DELETE')
