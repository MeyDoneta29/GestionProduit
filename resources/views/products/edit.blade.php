    ...
    <div class="container">
        ...
        <form action="{{ route('products.update', $produit->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" value="{{ old('name', $produit->name) }}" required>
            ...
            <div class="form-group">
                ...
                <input type="number" id="price" name="price" step="0.01" value="{{ old('price', $produit->price) }}" required>
                @error('price') <div class="error-text">{{ $message }}</div> @enderror
            </div>

            <div class="form-group">
                <label for="quantity">Quantité <span class="required">*</span></label>
                <input type="number" id="quantity" name="quantity" value="{{ old('quantity', $produit->quantity) }}" required>
